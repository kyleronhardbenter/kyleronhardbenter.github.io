...
const GENERAL_PIN_HASH = null;
const DOC_DOWNLOAD_PIN_HASH = null;
const GENERAL_PIN_PLAIN = 'Krbp2003*';
const DOC_DOWNLOAD_PIN_PLAIN = '0230';
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    window.verifyPin = async function() {
        ...
        const expectedPinPlain = pinContext === 'doc-download' ? DOC_DOWNLOAD_PIN_PLAIN : GENERAL_PIN_PLAIN;
        const isValidPin = pin === expectedPinPlain;
        if (!isValidPin) {
            pinGuard.attempts += 1;
